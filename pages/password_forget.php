        ...
        <form id="resetForm" method="post" action="../pages/password_lookup.php" enctype="multipart/form-data">
            ...
            <div class="card">
                ...
                <div class="card-body mb-1">
                    ...
                    <button class="btn btn-coekku btn-block" type="submit" name="resetPassword" value="รีเซ็ตรหัสผ่าน">รีเซ็ตรหัสผ่าน</button>
                    <div class="text-center"><a href="../login/" class="text-danger">ล็อกอิน</a></div>
                </div>
            </div>
        </form>
    </div>
